...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // Line 1
    // glVertex3f(detector.m_segment.m_start.m_xPos,
    // detector.m_segment.m_start.m_yPos, detector.m_segment.m_start.m_zPos);
    // glVertex3f(detector.m_segment.m_end.m_xPos,
    // detector.m_segment.m_end.m_yPos, detector.m_segment.m_end.m_zPos);
