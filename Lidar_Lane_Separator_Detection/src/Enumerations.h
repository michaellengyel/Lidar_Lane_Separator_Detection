...
//============================================================================================================
// The Enumerations .h holds parameters. This should be refactored to be
...
enum class vehicleParameters : unsigned int { SENSOR_HEIGHT = 3 };

constexpr bool g_filterDuplicateReturn =
    true; // Turn filtering of duplicates on and off
